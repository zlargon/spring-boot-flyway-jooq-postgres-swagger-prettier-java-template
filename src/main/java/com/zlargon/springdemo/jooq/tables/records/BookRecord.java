...
public class BookRecord extends UpdatableRecordImpl<BookRecord> implements Record2<Integer, String> {
  ...
  /**
   * Setter for <code>spring_demo.book.id</code>.
   */
  ...
  /**
   * Getter for <code>spring_demo.book.id</code>.
   */
  ...
  /**
   * Setter for <code>spring_demo.book.title</code>.
   */
  ...
  /**
   * Getter for <code>spring_demo.book.title</code>.
   */
